                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full p-2 mt-1 rounded-lg bg-red-50 dark:bg-slate-800 border border-red-100 dark:border-slate-700"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    required
                                    className="w-full p-2 mt-1 rounded-lg  bg-red-50 dark:bg-slate-800 border border-red-100 dark:border-slate-700 dark:text-white"
                                />
                            </div>
