...
const RemoteWork = () => {
    ...
    const handleChange = (e) => {
        ...
        setremoteWorkData({ ...remoteWorkData, [name]: value });
    };

    const handleSubmit = (e) => {
        e.preventDefault();
        if (editForm) {
            console.log("Edited Leave:", remoteWorkData);
            alert("Form updated!");
        } else {
            console.log("New Leave:", remoteWorkData);
            ...
            <div className="flex flex-col justify-center sm:flex-row sm:items-center sm:justify-between mb-4 p-2 sm:p-4">
                <div className="flex flex-col">
                    ...
                    <ul className="flex items-center text-sm mt-2">
                        ...
                        <li className="text-slate-600 dark:text-slate-50">Work From Home</li>
                    </ul>
                </div>
                {/* Add New Leave */}
                <button
                    ...
                    className="flex mt-4 sm:mt-0 items-center gap-2 px-3 py-2  rounded-lg bg-gradient-to-r from-red-700 to-black text-white"
                >
                    <PlusSquare size={18} />
                    <span>Apply</span>
                </button>
                                    ...
                                    <div className="flex items-center gap-x-4">
                                        {remoteWorks.status === "approved" ? (
                                            ...
                                            <button
                                                ...
                                                onClick={() => handleEdit(remoteWorks)}
                                            >
                                                <PencilLine size={20} />
                                            </button>
                                        )}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-fadeIn">
                    <div className="bg-white dark:bg-slate-900 rounded-xl shadow-xl w-full max-w-lg p-6 relative animate-scaleIn">
                        ...
                        <h2 className="text-xl font-semibold mb-4 text-slate-800 dark:text-slate-100">
                            {editForm ? "Edit Form" : "Apply Remote Work"}
                        </h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    type="text"
                                    name="employees"
                                    value={remoteWorkData.employees}
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                >
                                    {editForm ? "Update Leave" : "Add Leave"}
                                </button>
                            </div>
                        </form>
                    </div>
