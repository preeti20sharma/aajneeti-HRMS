        ...
        <AuthLayout>
            <div className="flex w-full min-h-screen">
                ...
                <div className="flex flex-col w-full md:w-1/2 items-center justify-center bg-white dark:bg-gray-800">
                    <div >
                        <a href="/">
                            <img src={logo} alt="Logo" className="h-12  mx-auto mt-2" />
                        </a>
                    </div>
                    <div className="flex items-center justify-center w-full mx-auto   min-h-screen ">
                        <div className="  rounded-2xl p-1 w-full max-w-md transition-colors duration-300">
