...
export const Sidebar = forwardRef(({ collapsed }, ref) => {
    return (
        ...
        >
            <div className="items-center gap-x-3 p-3">
                <img
                    src={logoLight}
                    alt="Logoipsum"
                    className="dark:hidden w-[110px] rounded-md  "
                />
                <img
                    src={logoDark}
                    alt="Logoipsum"
                    className="hidden dark:block w-[110px] rounded-md "
                />
                {/* {!collapsed && <p className="text-lg mt-3 font-medium text-slate-900 transition-colors dark:text-slate-50">Aajneeti</p>} */}
            </div>
